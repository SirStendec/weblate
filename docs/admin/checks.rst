...
``python-format``, ``c-format``, ``object-pascal-format``, ``php-format``, ``python-brace-format``, ``javascript-format``, ``icu-message-format``, ``c-sharp-format``, ``java-format``, ``java-messageformat``, ``lua-format``, ``auto-java-messageformat``, ``qt-format``, ``qt-plural-format``, ``ruby-format``, ``scheme-format``, ``vue-format``
    ...
    :ref:`check-c-sharp-format`, :ref:`check-java-format`, :ref:`check-icu-message-format`,
...
``icu-flags:FLAGS``
    Changes the behavior of :ref:`check-icu-message-format`.
``ignore-bbcode``
